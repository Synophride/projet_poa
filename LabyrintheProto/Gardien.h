...
const char EXPLORATION = 0;
const char DEFENSE = 1;
const char ATTAQUE = 2;
...
class Gardien : public Mover {
    ...
    **/
    ...
    /**
     * \brief Renvoie la décision de stratégie du gardien:
     * \returns EXPLORATION si le gardien décide d'explorer, 
     * ATTAQUE si le gardien décide d'attaquer le joueur, 
     * DEFENSE si le gardien décide d'aller défendre le trésor
     */
    char decision();
